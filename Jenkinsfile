    ...
    stage('build') {
     ...
     //       sh "docker tag mysqlnodejsmicroservice_users-service ankurdixit82/mysqlnodejsmicroservice_users-service:latest"
         //    sh "docker login -u ****** -p *****"     
             ...
             sh "docker tag -f users_service:latest 52.76.36.139:5000/docker_users-service:latest"
             sh "docker tag -f eiadatabase:latest 52.76.36.139:5000/docker_db:latest"
             sh "docker push -f 52.76.36.139:5000/docker_users-service:latest"
             sh "docker push -f 52.76.36.139:5000/docker_db:latest" 
